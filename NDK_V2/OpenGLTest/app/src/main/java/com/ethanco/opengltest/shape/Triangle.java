package com.ethanco.opengltest.shape;
...
//        投影矩阵
    ...
    public Triangle() {
        ByteBuffer bb = ByteBuffer.allocateDirect(triangleCoords.length * 4); //float 4个字节
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        GLES20.glVertexAttribPointer(mPositionHandle, 3, GLES20.GL_FLOAT, false, 3 * 4, vertexBuffer); //3:triangleCoords行数 4:float 4个字节
